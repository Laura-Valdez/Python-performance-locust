...
import sys
import random
sys.path.append(r"C:\Users\lavaldez\Documents\Project_of_guide\Phyton-locust")

from utilities.csvreader import CSVReader

my_reader=CSVReader(r"C:\Users\lavaldez\Documents\Project_of_guide\Phyton-locust\data\credential_csv_newtour.csv").read_data()
