...
import sys
sys.path.append("C:\Users\lavaldez\Documents\Project of guide\Phyton-locust\locustscript")
...
## toca arreglarlo dado que hay campos y dartos que no son iguales al video volver a verlo
# Custom load shapes coloca ejemplo por si queremos cambiar la forma en que sube los usuarios de performas por si se quiere un pico
#o 2 picos  https://docs.locust.io/en/stable/custom-load-shape.html