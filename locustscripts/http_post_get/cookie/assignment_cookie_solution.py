    ...
    def on_start(self):
        ...
        with self.client.post("/InsuranceWebExtJS/index.jsf"
            ...
            if ("Logged in") not in res1.text:
                ...
                print(res1.cookies['UserSessionFilter.sessionId'])
...
class MyUser(HttpUser):
    ...
    ##locust -f .\locustscripts\assignment_cookie_solution.py -u 1 -r 1 -t 30s --headless --only-summary
# activa el coockies y valida que se active y se almacena esa ckookies